...
3. `.cursor/knowledge/mabl-verification-agent/` — agent-specific methodology (local-run patterns, authoring best practices, failure RCA methodology, triage routing rules)
